...
class AudioProcessor:
    ...
    def remove_mouth_sounds(self, files: Union[str, List[str]], additional_config: Dict[str, Any] = None) -> Dict[
        str, Any]:
    ...
    def remove_hesitations(self, files: Union[str, List[str]], additional_config: Dict[str, Any] = None) -> Dict[
        str, Any]:
    ...
    def mute_segments(self, files: Union[str, List[str]], mute_lufs: int = -80,
    ...
    def denoise_audio(self, files: Union[str, List[str]], keep_music: bool = False,
                      additional_config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def reduce_breath_sounds(self, files: Union[str, List[str]], mute_lufs: int = -80,
                             additional_config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def normalize_audio(self, files: Union[str, List[str]], target_lufs: int = -16,
                        additional_config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def set_mute_lufs(self, files: Union[str, List[str]], mute_lufs: int, additional_config: Dict[str, Any] = None) -> \
    Dict[str, Any]:
    ...
    def set_target_lufs(self, files: Union[str, List[str]], target_lufs: int,
                        additional_config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def export_audio(self, files: Union[str, List[str]], format: str = "auto",
                     additional_config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def transcribe_audio(self, files: Union[str, List[str]], additional_config: Dict[str, Any] = None) -> Dict[
        str, Any]:
    ...
    def create_social_content(self, files: Union[str, List[str]], additional_config: Dict[str, Any] = None) -> Dict[
        str, Any]:
    ...
    def merge_tracks(self, files: List[str], normalize: bool = True, additional_config: Dict[str, Any] = None) -> Dict[
        str, Any]:
    ...
    def wait_for_completion(self, edit_id: str, poll_interval: int = 5000, max_wait_time: int = 300000) -> Dict[
        str, Any]:
        """
    ...
    def enhance_audio_comprehensive(self, files: Union[str, List[str]], options: Dict[str, Any] = None) -> Dict[
        str, Any]:
        """
